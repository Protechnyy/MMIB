...
class NERTrainer(BaseTrainer):
    ...
    def _step(self, batch, mode="train"):
        ...
        output, dis_loss, txt_kdl, img_kdl = self.model(input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids, labels=labels, images=images, aux_imgs=aux_imgs, mode=mode)
